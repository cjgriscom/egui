...
pub enum Event {
    ...
    /// The platform's text-input system (e.g. the EditContext API or a mobile
    /// virtual keyboard) has changed the text buffer externally.
    ///
    /// When this is received the focused [`crate::TextEdit`] should replace its
    /// entire contents and reposition the cursor.
    TextChanged {
